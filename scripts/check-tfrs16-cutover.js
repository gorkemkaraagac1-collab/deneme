...
const checks = [
  ...
  ["Contract detail tab navigation remains namespaced", /renderContractDetailTabs,/.test(reportingUi) && /gk-detail-tabs/.test(reportingUi) && /gkApplyDetailTab/.test(engine)],
