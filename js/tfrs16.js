document.addEventListener("DOMContentLoaded", () => {
  ...
  */
  ...
  function integrationPaymentTiming(value) {
    const raw = integrationNormalizeHeader(value);
    if (!raw) return undefined;
    if (["advance", "in advance", "donem basi", "donem basi odeme", "pesin"].includes(raw)) return "advance";
    if (["arrears", "in arrears", "donem sonu", "donem sonu odeme", "vadeli"].includes(raw)) return "arrears";
    return undefined;
  }
