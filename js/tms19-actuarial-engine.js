...
/* ================================================================
   FAZ 7 — TMS 19 PLAN VARLIKLARI + NET TANIMLI FAYDA YÜKÜMLÜLÜĞÜ
   Faz 1–6 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.planVarligiHesapla =
    function ({
        openingPlanAsset = 0,
        employerContributions = 0,
        benefitsPaid = 0,
        actualReturn = 0,
        closingPlanAsset = null
    } = {}) {
        ...
        const contributions =
            Math.max(
                0,
                TMS19.sayi(employerContributions)
            );
        ...
        const closing =
            closingPlanAsset === null
                ...
                : Math.max(
                    0,
                    TMS19.sayi(closingPlanAsset)
                );

        const assetExperience =
            closing -
            expected -
            actual;

        return {
            openingPlanAsset: opening,
            employerContributions: contributions,
            benefitsPaid: paid,
            actualReturn: actual,
            expectedClosingPlanAsset: expected,
            closingPlanAsset: closing,
            assetExperience
        };
    };


TMS19.planVarligiNetFaiz =
    function ({
        openingPlanAsset = 0,
        iskontoOrani = 0
    } = {}) {
...
TMS19.fonVarligiGerceklesenGetiri =
    function ({
        openingPlanAsset = 0,
        contributions = 0,
        benefitsPaid = 0,
...
TMS19.varlikTavanTesti =
    function ({
        planAsset = 0,
        presentValueOfEconomicBenefits = 0
    } = {}) {
        ...
        const economicBenefit =
            Math.max(
                0,
                TMS19.sayi(
                    presentValueOfEconomicBenefits
                )
            );

        return {
            grossPlanAsset: asset,
            economicBenefit,
            assetCeiling:
                Math.min(
                    asset,
            ...
            excessPlanAsset:
                Math.max(
                    0,
                    asset - economicBenefit
                )
        };
    };


TMS19.faz7PersonelHesapla =
    function (
        personel,
        varsayimlar = {},
        index = 0
        ...
        const plan =
            TMS19.planVarligiHesapla({
                ...
                employerContributions:
                    personel.employerContributions ??
                    personel.isverenKatkisi ??
                    0,
                ...
                actualReturn:
                    personel.actualPlanAssetReturn ??
                    personel.fonGerceklesenGetiri ??
                    0,

                closingPlanAsset:
                    personel.closingPlanAsset ??
                    null
            });
        ...
        const ceiling =
            TMS19.varlikTavanTesti({
                ...
                presentValueOfEconomicBenefits:
                    personel.presentValueOfEconomicBenefits ??
                    varsayimlar.presentValueOfEconomicBenefits ??
                    0
            });
        ...
        return {
            ...
            actualPlanAssetReturn:
                plan.actualReturn,

            expectedClosingPlanAsset:
                plan.expectedClosingPlanAsset,

            closingPlanAsset:
                plan.closingPlanAsset,

            planAssetExperience:
                plan.assetExperience,

            dboInterest:
                netInterest.dboInterest,

            planAssetInterest:
                netInterest.planAssetInterest,

            netInterest:
                netInterest.netInterest,

            netDefinedBenefitLiability:
                net.netDefinedBenefitLiability,

            fundedStatus:
                net.fundedStatus,

            grossPlanAsset:
                ceiling.grossPlanAsset,

            economicBenefit:
                ceiling.economicBenefit,

            assetCeiling:
                ceiling.assetCeiling,

            excessPlanAsset:
                ceiling.excessPlanAsset
        };
    };


TMS19.faz7PortfoyHesapla =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
        ...
        const toplam = {
            ...
            employerContributions: 0,
            planBenefitsPaid: 0,
            actualPlanAssetReturn: 0,
            closingPlanAsset: 0,
            netDefinedBenefitLiability: 0,
            assetCeiling: 0,
            excessPlanAsset: 0,
            netInterest: 0
        };
        ...
        personeller.forEach(
            (personel, index) => {
                ...
                try {
                    ...
                    toplam.openingPlanAsset +=
                        TMS19.sayi(
                            sonuc.openingPlanAsset
                        );

                    toplam.employerContributions +=
                        TMS19.sayi(
                            sonuc.employerContributions
                        );

                    toplam.planBenefitsPaid +=
                        TMS19.sayi(
                            sonuc.planBenefitsPaid
                        );

                    toplam.actualPlanAssetReturn +=
                        TMS19.sayi(
                            sonuc.actualPlanAssetReturn
                        );

                    toplam.closingPlanAsset +=
                        TMS19.sayi(
                            sonuc.closingPlanAsset
                        );

                    toplam.netDefinedBenefitLiability +=
                        TMS19.sayi(
                            sonuc.netDefinedBenefitLiability
                        );
                    ...
                    toplam.excessPlanAsset +=
                        TMS19.sayi(
                            sonuc.excessPlanAsset
                        );
...
TMS19.faz7Kontrol =
    function (sonuc) {
        ...
        const expectedNet =
            TMS19.sayi(t.dbo) -
            TMS19.sayi(t.closingPlanAsset);

        if (
            Math.abs(
                expectedNet -
                TMS19.sayi(
                    t.netDefinedBenefitLiability
                )
            ) > 0.01
        ) {
            errors.push(
                "Net tanımlı fayda yükümlülüğü reconcile olmadı."
            );
        }
        ...
        if (
            ...
            errors.push(
                "Kapanış plan varlığı negatif olamaz."
            );
        }
...
/* ================================================================
   FAZ 7 — RAPOR ENTEGRASYONU
================================================================ */

TMS19.faz7RaporOlustur =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
...
/* ================================================================
   FAZ 8 — TMS 19 HAREKETLER / FAYDA ÖDEMELERİ / SETTLEMENT
   Faz 1–7 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.faydaHareketiHesapla =
    function ({
        openingDBO = 0,
        currentServiceCost = 0,
        pastServiceCost = 0,
        ...
        const closing =
            closingDBO === null
                ? expectedClosing
                : TMS19.sayi(closingDBO);

        return {
            openingDBO: opening,
            currentServiceCost: service,
            pastServiceCost: past,
            interestCost: interest,
            actuarialGainLoss: actuarial,
            benefitsPaid: paid,
            ...
            expectedClosingDBO: expectedClosing,
            closingDBO: closing,
            reconciliationDifference:
...
TMS19.settlementKazancKaybi =
    function ({
        settlementObligation = 0,
        settlementPayment = 0,
        settlementDBO = null
    } = {}) {
...
TMS19.faydaOdemeAnalizi =
    function ({
        ...
        const count =
            Math.max(
                0,
                TMS19.sayi(personelSayisi)
            );

        return {
            totalBenefitsPaid: paid,

            averageBenefitPerPerson:
                count > 0
                    ? paid / count
                    : 0,

            benefitToOpeningDBORatio:
                opening !== 0
                    ? paid / opening
                    : 0,

            benefitToClosingDBORatio:
                closing !== 0
                    ? paid / closing
                    : 0
        };
...
TMS19.faz8PersonelHesapla =
    function (
        ...
        const settlement =
            TMS19.settlementKazancKaybi({
                settlementObligation:
                    personel.settlementObligation ??
                    0,

                settlementPayment:
                    personel.settlementPayment ??
                    0,

                settlementDBO:
                    personel.settlementDBO ??
                    null
            });
        ...
        return {
            ...
            expectedClosingDBO:
                hareket.expectedClosingDBO,

            closingDBO:
                hareket.closingDBO,

            benefitsPaid:
                hareket.benefitsPaid,

            settlements:
                hareket.settlements,

            contributions:
                hareket.contributions,

            dboReconciliationDifference:
                hareket.reconciliationDifference,

            settlementGainLoss:
                settlement.settlementGainLoss
        };
    };


TMS19.faz8PortfoyHesapla =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
...
TMS19.faz8Kontrol =
    function (sonuc) {
        ...
        const expected =
            ...
            TMS19.sayi(t.currentServiceCost) +
            TMS19.sayi(t.pastServiceCost) +
            TMS19.sayi(t.interestCost) -
            TMS19.sayi(t.actuarialGainLoss) -
            TMS19.sayi(t.benefitsPaid) -
            TMS19.sayi(t.settlements) +
            TMS19.sayi(t.contributions);
        ...
        if (
            ...
            errors.push(
                "Faz 8 DBO hareketleri reconcile olmadı."
            );
        }
...
/* ================================================================
   FAZ 9 — TMS 19 KIDEM TAZMİNATI / HİZMET YILI / VESTING
   Faz 1–8 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.hizmetYiliHesapla =
    function ({
        baslangicTarihi = null,
        degerlemeTarihi = null,
        dogrudanHizmetYili = null
    } = {}) {

        if (
            dogrudanHizmetYili !== null &&
            Number.isFinite(
                Number(dogrudanHizmetYili)
            )
        ) {
            return Math.max(
                0,
...
TMS19.vestingOraniHesapla =
    function ({
        ...
        const hizmet =
            Math.max(
                0,
                TMS19.sayi(hizmetYili)
            );

        const sure =
            Math.max(
                0,
                TMS19.sayi(vestingSuresi)
            );
    ...
    function (
        ...
        const vestingOrani =
            TMS19.vestingOraniHesapla({
                ...
                vestingSuresi:
                    personel.vestingSuresi ??
                    varsayimlar.vestingSuresi ??
                    0
            });

        const toplamFayda =
            personel.toplamFayda ??
            personel.kidemTazminati ??
            faz8.dbo ??
            0;
        ...
        return {
            ...
            kazanilmisFayda:
                vested.kazanilmisFayda,

            kazanilmamisFayda:
                vested.kazanilmamisFayda
        };
    };


TMS19.faz9PortfoyHesapla =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
        ...
        personeller.forEach(
            (personel, index) => {
                ...
                try {
                    ...
                    toplam.kazanilmisFayda +=
                        TMS19.sayi(
                            sonuc.kazanilmisFayda
                        );

                    toplam.kazanilmamisFayda +=
                        TMS19.sayi(
                            sonuc.kazanilmamisFayda
                        );
...
TMS19.faz9Kontrol =
    function (sonuc) {
        ...
        if (
            ...
            errors.push(
                "Vested/unvested fayda reconcile olmadı."
            );
        }
...
/* ================================================================
   FAZ 10 — TMS 19 DEMOGRAFİK HAREKETLER + ÇALIŞAN DEVRİ
   Faz 1–9 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.devirOraniUygula =
    function ({
...
TMS19.faz10PersonelHesapla =
    function (
        ...
        return {
            ...
            beklenenAyrilisOlasiligi:
                beklenenAyrilis.beklenenAyrilis,

            beklenenKalanOlasiligi:
                beklenenAyrilis.beklenenKalan
        };
    };


TMS19.faz10PortfoyHesapla =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
        ...
        const toplam = {
            devirOlasiligi: 0,
            beklenenAyrilisOlasiligi: 0,
            beklenenKalanOlasiligi: 0
        };
        ...
        personeller.forEach(
            (personel, index) => {
                ...
                try {
                    ...
                    toplam.devirOlasiligi +=
                        TMS19.sayi(
                            sonuc.devirOlasiligi
                        );

                    toplam.beklenenAyrilisOlasiligi +=
                        TMS19.sayi(
                            sonuc.beklenenAyrilisOlasiligi
                        );

                    toplam.beklenenKalanOlasiligi +=
                        TMS19.sayi(
                            sonuc.beklenenKalanOlasiligi
                        );
...
TMS19.faz10Kontrol =
    function (sonuc) {
        ...
        const fark =
            TMS19.sayi(
                t.beklenenAyrilisOlasiligi
            ) +
            TMS19.sayi(
                t.beklenenKalanOlasiligi
            ) -
            TMS19.sayi(
                sonuc.personelSayisi
            );
        ...
        if (
            ...
            errors.push(
                "Devir olasılığı hareketi reconcile olmadı."
            );
        }
...
/* ================================================================
   FAZ 11 — TMS 19 ÖLÜM / EMEKLİLİK / HİZMET SONU PROJEKSİYONU
   Faz 1–10 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.gerceklesmeOlasiligi =
    function ({
        yas = 0,
        tablo = null,
        sabitOran = 0
        ...
        return Math.min(
            ...
            Math.max(
                0,
                TMS19.sayi(sabitOran)
            )
        );
    };


TMS19.hizmetSonuOlasiliklari =
    function ({
        yas = 0,
        emeklilikYasi = 65,
        olumTablosu = null,
        ...
        return {
            ...
            retirementProbability: retirement,
...
TMS19.faz11PersonelProjeksiyonu =
    function (
        personel,
        varsayimlar = {}
    ) {
        ...
        periods.forEach(
            period => {
                ...
                const deathExit =
                    survival *
                    probabilities.deathProbability;
                ...
                const retirementExit =
                    survival *
                    probabilities.retirementProbability;
...
TMS19.faz11PortfoyProjeksiyonu =
    function (
        personeller = [],
        varsayimlar = {}
    ) {
        ...
        personeller.forEach(
            (personel, index) => {
                ...
                try {
                    ...
                    toplam.toplamEmeklilik +=
                        TMS19.sayi(
                            sonuc.toplamEmeklilik
                        );

                    toplam.nihaiHayattaKalma +=
                        TMS19.sayi(
                            sonuc.nihaiHayattaKalma
                        );
...
/* ================================================================
   FAZ 12 — TMS 19 AKTÜERYAL KAZANÇ/KAYIPLAR + OCI ANALİZİ
   Faz 1–11 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.aktuerKazanclariHesapla =
    function ({
        demographicGainLoss = 0,
        financialGainLoss = 0,
        experienceAdjustment = 0,
        assumptionChange = 0,
        planAssetExperience = 0
    } = {}) {
...
TMS19.ociKumulatifHesapla =
    function ({
        ...
        const opening =
            TMS19.sayi(openingOCI);

        const current =
            TMS19.sayi(currentOCI);

        const transferred =
            TMS19.sayi(transferredOCI);

        return {
            openingOCI: opening,
            currentOCI: current,
            transferredOCI: transferred,
            closingOCI:
                opening +
                current +
                transferred
    ...
    function (
        ...
        const aktuer =
            TMS19.aktuerKazanclariHesapla({
                ...
                demographicGainLoss:
                    personel.demographicGainLoss ??
                    0,

                financialGainLoss:
                    personel.financialGainLoss ??
                    0,

                experienceAdjustment:
                    personel.experienceAdjustment ??
                    0,
                ...
                planAssetExperience:
                    personel.planAssetExperience ??
                    faz11.planAssetExperience ??
                    0
            });
        ...
        return {
            ...
            demographicGainLoss:
                aktuer.demographicGainLoss,

            financialGainLoss:
                aktuer.financialGainLoss,

            experienceAdjustment:
                aktuer.experienceAdjustment,

            assumptionChange:
                aktuer.assumptionChange,

            dboActuarialGainLoss:
                aktuer.dboActuarialGainLoss,

            planAssetExperience:
                aktuer.planAssetExperience,
...
TMS19.faz12Kontrol =
    function (sonuc) {
        ...
        const expectedOCI =
            TMS19.sayi(
                t.dboActuarialGainLoss
            ) -
            TMS19.sayi(
                t.planAssetExperience
            );
        ...
        if (
            ...
            errors.push(
                "OCI aktüeryal hareketleri reconcile olmadı."
            );
        }
...
/* ================================================================
   FAZ 13 — TMS 19 VARSAYIM DEĞİŞİKLİĞİ / DUYARLILIK ANALİZİ
   Faz 1–12 fonksiyonlarını tekrar tanımlamaz.
================================================================ */
...
TMS19.faz13Karsilastir =
    function (senaryoSonucu) {

        if (!senaryoSonucu?.senaryolar) {
            return {
                valid: false,
                errors: [
                    "Senaryo sonucu bulunamadı."
                ]
            };
        }

        const baz =
            senaryoSonucu.senaryolar[0];
...
TMS19.faz13StandartSenaryolar =
    function () {

        return [
            {
                ad:
                    "İskonto Oranı +1 puan",

                degisiklikler: {
                    iskontoOraniDegisimi:
                        0.01
                }
            },
...
TMS19.faz13Kontrol =
    function (sonuc) {
        ...
        sonuc.senaryolar?.forEach(
            senaryo => {

                if (
                    senaryo.hesap?.success === false
                ) {
                    errors.push(
                        `${senaryo.ad} hesaplaması başarısız.`
                    );
                }
            }
        );
...
/* ================================================================
   FAZ 14 — TMS 19 DİPNOT / MUTABAKAT / DENETİM KONTROLÜ
   Faz 1–13 fonksiyonlarını tekrar tanımlamaz.
================================================================ */

TMS19.dipnotMutabakatHesapla =
    function ({
        openingDBO = 0,
        currentServiceCost = 0,
        pastServiceCost = 0,
        ...
        const planExpected =
            TMS19.sayi(openingPlanAsset) +
            TMS19.sayi(contributions) +
            TMS19.sayi(planAssetInterest) +
            TMS19.sayi(actualPlanAssetReturn) -
            TMS19.sayi(planBenefitsPaid);
        ...
        return {
            ...
            dboReconciled:
                Math.abs(dboDifference) <= 0.01,

            planAssetReconciled:
                Math.abs(planDifference) <= 0.01,
...
TMS19.denetimKontrolPaketi =
    function (sonuc) {
        ...
        add(
            "TMS19-001",
            "DBO mutabakatı",
            sonuc?.mutabakat?.dboReconciled,
            sonuc?.mutabakat?.dboReconciled
                ? "DBO hareketleri mutabık."
                : "DBO hareketlerinde fark var."
        );

        add(
            "TMS19-002",
            "Plan varlığı mutabakatı",
            sonuc?.mutabakat?.planAssetReconciled,
            sonuc?.mutabakat?.planAssetReconciled
                ? "Plan varlığı hareketleri mutabık."
                : "Plan varlığı hareketlerinde fark var."
        );
        ...
        add(
            ...
            "Net tanımlı fayda yükümlülüğü hesaplandı."
        );
        ...
        add(
            ...
            "Personel sayısı",
            TMS19.sayi(
                sonuc?.kpi?.personelSayisi
            ) >= 0,
            "Personel sayısı geçerli."
        );
...
TMS19.faz14Kontrol =
    function (rapor) {
        ...
        if (
            !rapor.mutabakat?.reconciled
        ) {
            errors.push(
                "TMS 19 dipnot mutabakatı başarısız."
            );
        }

        if (
            !rapor.denetim?.hepsiBasarili
        ) {
            errors.push(
                "Denetim kontrol paketinde başarısız kontrol var."
            );
        }
