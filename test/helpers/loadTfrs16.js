/**
 * tfrs16-engine.js, bütün fonksiyonlarını tek bir
 ...
 *    tfrs16-engine.js'in sonuna eklenmiş olan (additive) test-export
 *    shim'i çalıştığında bunları window.__TFRS16_TEST__ üzerine
 *    koyuyor. Biz de olay ateşlendikten sonra oradan okuyoruz.
 *
 * Not: tfrs16-engine.js her require edildiğinde kendi init akışını
...
function loadTfrs16() {
  ...
  if (!window.__TFRS16_TEST__) {
    throw new Error(
      "window.__TFRS16_TEST__ boş — tfrs16-engine.js sonundaki test export shim'i " +
